...
public sealed partial class ContourDetectionPage : Page
{
    public ContourDetectionViewModel ViewModel { get; }

    public ContourDetectionPage()
    {
        ViewModel = App.GetService<ContourDetectionViewModel>();
        InitializeComponent();
    }
