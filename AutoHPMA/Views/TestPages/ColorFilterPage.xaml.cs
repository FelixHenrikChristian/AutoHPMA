...
public sealed partial class ColorFilterPage : Page
{
    public ColorFilterViewModel ViewModel { get; }

    public ColorFilterPage()
    {
        ViewModel = App.GetService<ColorFilterViewModel>();
        InitializeComponent();
    }
